...
export default function AddContent(isCategory: boolean, id: string | boolean, categoryName?: string, title?: string, year?: number, isSeries?: boolean, season?: number | [number, number] | string, end?: null | number | string, onSave?: (categoryName: string) => void) {
    if (isCategory) {
        if (categoryName) {
            const newCategory = {
